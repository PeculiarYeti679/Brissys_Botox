...
export default function Footer() {
  return (
    <nav className="bg-coral p-4 relative inset-x-0 bottom-0 drop-shadow-xl z-10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-3 gap-4 items-center text-white">
        <div className="flex flex-col items-center sm:items-start">
          <h1 className="text-lg font-bold font-serif mb-2">
            <Link href="/" >
              <p className="text-white/90 no-underline hover:text-rosequartz">Brissy&apos;s Botox</p>
            </Link>
          </h1>
          <p className="text-sm font-serif text-center sm:text-left">
          Copyright &copy; 2024 Brissy&apos;s Botox, all rights reserved.
          </p>
        </div>
